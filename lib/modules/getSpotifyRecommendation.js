 ...
 * @param currentId > Spotify CLIENT_ID (string)
 * @param currentSecret > Spotify CLIENT_SECRET (string)
 * @param grantType > 'client_credentials'
 * @param json > 'true'
*/
class AuthForToken {
  constructor(currentId = CLIENT_ID, currentSecret = CLIENT_SECRET, grantType = 'client_credentials', json = true) {
...
/** Checks whether a default is set for CLIENT_ID AND clientSecrets.
 * @returns boolean
*/
const checkSpotifyClientInfo = () => {
  if (typeof CLIENT_ID === typeof null || typeof CLIENT_SECRET === typeof null) {
    return false;
  }
  return true;
};
